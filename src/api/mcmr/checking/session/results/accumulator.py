...
if TYPE_CHECKING:
    ...
    from ....domain.contracts import EngineStats, RuleDefinition
...
class JudgmentAccumulator:
    ...
    def finish(
        ...
        *,
        ...
        """Return the complete judgment after the last streamed batch."""
        ...
        return Verdicts(
            ...
            rules=self.state.rule_judgments(self.definitions),
