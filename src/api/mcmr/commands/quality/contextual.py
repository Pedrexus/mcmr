...
from .contextual_reporting import ContextualPresentation
...
def model_sweep(
    ...
    *,
    ...
    workers: maximum isolated model operations active at once.
    model: optional model override used only for this stateless sweep.
    reasoning_effort: optional reasoning override used only for this stateless sweep.
