...
@rule
def missing_data_field_reference(subject: DataFieldReferenceFact) -> Count:
    ...
    """
    return sum(
        reference.asset_exists and not reference.field_exists for reference in subject.references
    )
